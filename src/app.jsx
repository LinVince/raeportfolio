...
function Hero() {
  return (
    <section className="hero">
      <div className="squiggle-wrap" style={{ left: -10, top: 80, height: '90%', width: 100 }}>
        <Squiggle width={100} height={600} color="#6b9fd4" />
      </div>
      <div className="hero-inner">
        ...
        <div className="hero-right">
          ...
          <div className="info-card yellow">
            ...
            <p style={{marginTop:'0.4rem'}}>I'm adaptable and quick to get up to speed with new tools as projects require.</p>
          </div>
          <div className="info-card">
  ...
  return (
    <section className="about-section" id="about">
      <div className="about-inner">
        <div>
          <h2 className="about-tagline">I'm a creative problem solver with a knack for those knotty problems</h2>
          <p className="about-bio">
            I'm a curious, thoughtful designer-researcher who brings structure, calm and a lot of joy to complex spaces. I help teams untangle problems, understand users and make sense of the mess, so we can turn insight into action and build things that really work.
          </p>
          <p className="about-detail">
            I've led research and design across justice, education and housing. I guide strategy, navigate change and support teams with calm and clarity.
          </p>
        </div>
        <div className="about-stats">
          ...
          <div className="stat-card">
            ...
            <h4>Figma, Adobe, Miro, Lucid, Trello, JRA</h4>
            <p>I'm adaptable and quick to get up to speed with new tools as projects require.</p>
          </div>
          <div className="stat-card">
            <h4>London raised, NZ born</h4>
            <p>A cross-cultural perspective to help shape that different way to think about design.</p>
          </div>
        </div>
      </div>
    </section>
